...
static const TSCharacterRange sym__text_character_set_1[] = {
  {0, 0x08}, {0x0e, 0x1f}, {'!', ')'}, {'+', '?'}, {'A', 'z'}, {'|', '|'}, {'~', 0x17e}, {0x180, 0x2129},
  {0x212b, 0x10ffff},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 687, lookahead)) ADVANCE(426);
      if (lookahead != 0 &&
          (lookahead < 0xf8 || 0x2c1 < lookahead) &&
          (lookahead < 0x212a || 0x2139 < lookahead)) ADVANCE(444);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(4);
      if (lookahead == '*') ADVANCE(96);
    ...
    case 112:
      ...
      if ((!eof && set_contains(sym__text_character_set_1, 9, lookahead))) ADVANCE(444);
      END_STATE();
    case 113:
      if (lookahead != 0 &&
    ...
    case 198:
      ACCEPT_TOKEN(anon_sym_include);
      if (set_contains(sym_identifier_character_set_2, 803, lookahead)) ADVANCE(426);
      END_STATE();
    case 199:
