...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(250)] = 4687,
  [SMALL_STATE(251)] = 4691,
  [SMALL_STATE(252)] = 4695,
  [SMALL_STATE(253)] = 4699,
  [SMALL_STATE(254)] = 4703,
  [SMALL_STATE(255)] = 4707,
  [SMALL_STATE(256)] = 4711,
  [SMALL_STATE(257)] = 4715,
  [SMALL_STATE(258)] = 4719,
  [SMALL_STATE(259)] = 4723,
  [SMALL_STATE(260)] = 4727,
  [SMALL_STATE(261)] = 4731,
  [SMALL_STATE(262)] = 4735,
  [SMALL_STATE(263)] = 4739,
  [SMALL_STATE(264)] = 4743,
  [SMALL_STATE(265)] = 4747,
  [SMALL_STATE(266)] = 4751,
  [SMALL_STATE(267)] = 4755,
  [SMALL_STATE(268)] = 4759,
  [SMALL_STATE(269)] = 4763,
  [SMALL_STATE(270)] = 4767,
  [SMALL_STATE(271)] = 4771,
  [SMALL_STATE(272)] = 4775,
  [SMALL_STATE(273)] = 4779,
  [SMALL_STATE(274)] = 4783,
  [SMALL_STATE(275)] = 4787,
  [SMALL_STATE(276)] = 4791,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [116] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(242),
  [119] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [122] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(230),
  ...
  [524] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameter_mods_repeat1, 2, 0, 0), SHIFT_REPEAT(250),
  ...
  [601] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_system_property_repeat1, 2, 0, 0), SHIFT_REPEAT(212),
  [604] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_tag, 1, 0, 1),
  [606] = {.entry = {.count = 1, .reusable = true}}, SHIFT(253),
  [608] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 46),
  [610] = {.entry = {.count = 1, .reusable = true}}, SHIFT(186),
  [612] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [614] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_link_tag, 3, 0, 9),
  [616] = {.entry = {.count = 1, .reusable = true}}, SHIFT(237),
  [618] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4, 0, 48),
  [620] = {.entry = {.count = 1, .reusable = true}}, SHIFT(231),
  [622] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_tag, 2, 0, 22),
  [624] = {.entry = {.count = 1, .reusable = true}}, SHIFT(215),
  [626] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_tag, 2, 0, 23),
  ...
  [634] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_link_tag, 2, 0, 9),
  [636] = {.entry = {.count = 1, .reusable = true}}, SHIFT(184),
  [638] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_system_property, 2, 0, 0),
  [640] = {.entry = {.count = 1, .reusable = true}}, SHIFT(234),
  [642] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_snippet_tag, 2, 0, 26),
  [644] = {.entry = {.count = 1, .reusable = true}}, SHIFT(232),
  [646] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_custom_inline_tag, 1, 0, 1),
  [648] = {.entry = {.count = 1, .reusable = true}}, SHIFT(226),
  [650] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inline_return_tag, 1, 0, 1),
  [652] = {.entry = {.count = 1, .reusable = true}}, SHIFT(273),
  [654] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_tag, 1, 0, 1),
  [656] = {.entry = {.count = 1, .reusable = true}}, SHIFT(271),
  [658] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_system_property, 1, 0, 0),
  [660] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_summary_tag, 1, 0, 1),
  ...
  [668] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_snippet_tag, 5, 0, 47),
  [670] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [672] = {.entry = {.count = 1, .reusable = true}}, SHIFT(207),
  [674] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 4, 0, 0),
  [676] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_summary_tag, 2, 0, 27),
  [678] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_system_property_tag, 2, 0, 28),
  [680] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_tag, 1, 0, 0),
  [682] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_tag, 3, 0, 37),
  [684] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_tag, 3, 0, 38),
  [686] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 2, 0, 2),
  [688] = {.entry = {.count = 1, .reusable = true}}, SHIFT(206),
  [690] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_tag, 1, 0, 3),
  [692] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value_tag, 2, 0, 30),
  ...
  [706] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_system_property_repeat1, 2, 0, 0),
  [708] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [710] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [712] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_link_tag, 4, 0, 42),
  ...
  [720] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doc_root_tag, 1, 0, 1),
  ...
  [748] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 3, 0, 0),
  ...
  [784] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inline_return_tag, 2, 0, 8),
